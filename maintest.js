...
function navigateTo(page) {
    ...
    if (page === 'home') {
        ...
        // Ensure score is loaded before rendering
        if (!lastScore) {
    ...
    if (clearScoreBtn) {
        addClickListener(clearScoreBtn, () => {
            clearSavedScore(); // This clears localStorage AND sets lastScore = null
            showNotification('Score history cleared!', true);
            // Small delay to let notification show, then refresh
            setTimeout(() => {
